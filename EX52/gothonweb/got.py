class Scene(object):
    def __init__(self, title, urlname, description, hint, dead):
        self.title = title
...
""",
"""
I think smaller number would be better...
""",
"""
...
""",
"""
You don't need help because you made it!!
""",
"""
""")
...
generic_death = Scene("Death...", "death", "You died.","We can't help you..."," ")
